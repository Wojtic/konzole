...
namespace menu {
  ...
  Item pacman {pacman_data, sizeof(pacman_data)/sizeof(uint8_t), pacman_colors, color_dark_purple, "pacman"};
  ...
  Item settings {settings_data, sizeof(settings_data)/sizeof(uint8_t), settings_colors, color_white, "settings"};
  ...
  Item tetris {tetris_data, sizeof(tetris_data)/sizeof(uint8_t), tetris_colors, color_gray, "tetris"};
  ...
  Item snake {snake_data, sizeof(snake_data)/sizeof(uint8_t), snake_colors, color_lime, "snake"};
  ...
  Item mario {mario_data, sizeof(mario_data)/sizeof(uint8_t), mario_colors, color_light_blue, "mario"};
  ...
  Item piskvorky {piskvorky_data, sizeof(piskvorky_data)/sizeof(uint8_t), piskvorky_colors, color_white, "tic-tac-toe"};
  ...
  Item pong {pong_data, sizeof(pong_data)/sizeof(uint8_t), pong_colors, color_dark_gray, "pong"};
