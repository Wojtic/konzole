...
namespace menu {
  ...
  Item pacman {pacman_data, sizeof(pacman_data)/sizeof(uint8_t), pacman_colors, color_dark_purple, "pacman", 65000};
  ...
  Item settings {settings_data, sizeof(settings_data)/sizeof(uint8_t), settings_colors, color_white, "settings", 0};
  ...
  Item tetris {tetris_data, sizeof(tetris_data)/sizeof(uint8_t), tetris_colors, color_gray, "tetris", 0};
  ...
  Item snake {snake_data, sizeof(snake_data)/sizeof(uint8_t), snake_colors, color_lime, "snake", 0};
  ...
  Item mario {mario_data, sizeof(mario_data)/sizeof(uint8_t), mario_colors, color_light_blue, "mario", 0};
  ...
  Item piskvorky {piskvorky_data, sizeof(piskvorky_data)/sizeof(uint8_t), piskvorky_colors, color_white, "piskvorky", 0};
  ...
  Item pong {pong_data, sizeof(pong_data)/sizeof(uint8_t), pong_colors, color_dark_gray, "pong", 65000};
  ...
  void drawItem(int position) {
    ...
    tft.fillRoundRect(40+90*x, 50+90*y, 60, 60, 7, frame);
    tft.fillRoundRect(45+90*x, 55+90*y, 50, 50, 7, icons[position+scroll_position].background);
    if (position+scroll_position < icon_count) {
      drawIcon(54+90*x, 57+90*y, icons[position+scroll_position].data, icons[position+scroll_position].colors, icons[position+scroll_position].background, icons[position+scroll_position].len);
      tft.setTextSize(1);
      tft.setTextColor(icons[position+scroll_position].text_color);
      tft.setCursor(47+90*x, 92 + 90 * y);
      tft.print(icons[position+scroll_position].text);      
    }
  }
